...
exports.updateSubscriptionLimits = exports.updateSubscriptionFromPlan = exports.getOrCreateDefaultSubscription = void 0;
...
const updateSubscriptionLimits = async (userId, limits) => {
    const updateData = {};
    if (limits.maxTopics !== undefined)
        updateData.maxTopics = limits.maxTopics;
