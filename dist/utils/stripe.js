...
exports.verifyWebhookSignature = exports.getWebhookSecret = exports.stripe = void 0;
...
const verifyWebhookSignature = (payload, signature) => {
    try {
        return exports.stripe.webhooks.constructEvent(payload, signature, stripeWebhookSecret);
    }
    catch (error) {
