...
exports.getUserSubscription =
  exports.decrementDocumentCount =
  exports.incrementDocumentCount =
  exports.decrementQuizCount =
  exports.incrementQuizCount =
  exports.decrementTopicCount =
  exports.incrementTopicCount =
  exports.getUserUsage =
    void 0;
...
const decrementTopicCount = async (userId) => {
  await prisma_1.default.userUsage
    .update({
      where: { userId },
