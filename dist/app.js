...
app.post("/webhook", express_1.default.raw({ type: "application/json" }), subscription_controller_1.handleWebhook);
app.post("/api/v1/subscription/webhook", express_1.default.raw({ type: "application/json" }), subscription_controller_1.handleWebhook);
...
app.listen(PORT, () => {
    ...
    console.log(`Supabase URL: ${process.env.SUPABASE_URL || "http://127.0.0.1:55321"}`);
    console.log(`Google OAuth callback: ${process.env.SUPABASE_URL || "http://127.0.0.1:55321"}/auth/v1/callback`);
});
