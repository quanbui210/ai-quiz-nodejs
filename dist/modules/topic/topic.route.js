...
router.get(
  ...
  topic_controller_1.listTopics,
);
router.get("/:id", topic_controller_1.getTopic);
router.post(
  "/create",
  auth_middleware_1.authenticate,
  limit_check_middleware_1.checkTopicLimit,
  topic_controller_1.createTopic,
);
router.put(
  "/:id",
  auth_middleware_1.authenticate,
  topic_controller_1.updateTopic,
);
router.delete(
  "/:id",
  auth_middleware_1.authenticate,
  topic_controller_1.deleteTopic,
);
