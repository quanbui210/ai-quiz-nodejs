...
exports.deleteTopic = exports.updateTopic = exports.createTopic = exports.getTopic = exports.listTopics = void 0;
...
const deleteTopic = async (req, res) => {
    try {
        ...
        const questionIds = topic.quizzes.flatMap((q) => q.questions.map((q) => q.id));
        const attemptIds = topic.quizzes.flatMap((q) => q.attempts.map((a) => a.id));
        const operations = [];
        if (attemptIds.length > 0) {
            operations.push(prisma_1.default.answer.deleteMany({
                where: {
        ...
        if (quizIds.length > 0) {
            operations.push(prisma_1.default.quizAttempt.deleteMany({
                where: {
                    quizId: { in: quizIds },
                },
            }));
        ...
        if (questionIds.length > 0) {
            operations.push(prisma_1.default.explanation.deleteMany({
                where: {
                    questionId: { in: questionIds },
                },
            }));
        ...
        if (quizIds.length > 0) {
            operations.push(prisma_1.default.question.deleteMany({
                where: {
                    quizId: { in: quizIds },
                },
            }));
        ...
        if (quizIds.length > 0) {
            operations.push(prisma_1.default.quiz.deleteMany({
                where: {
                    topicId: id,
                },
            }));
        }
        operations.push(prisma_1.default.progress.deleteMany({
            where: {
                topicId: id,
            },
        }));
        operations.push(prisma_1.default.suggestion.deleteMany({
            where: {
                topicId: id,
            },
        }));
        operations.push(prisma_1.default.topic.delete({
            where: { id },
        }));
