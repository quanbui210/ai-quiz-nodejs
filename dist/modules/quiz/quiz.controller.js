...
exports.deleteQuiz =
  ...
  exports.getQuiz =
  exports.createQuiz =
  exports.testCreateQuiz =
  exports.validateQuizTopic =
  exports.suggestQuizTopic =
  exports.listQuizzes =
    void 0;
...
function parseQuizResponse(quizText) {
  try {
    ...
    const difficulty =
      difficultyMatch?.[1]?.toUpperCase() || client_1.Difficulty.INTERMEDIATE;
...
const createQuiz = async (req, res) => {
  try {
    ...
    if (
      !difficulty ||
      !Object.values(client_1.Difficulty).includes(difficulty)
    ) {
      return res.status(400).json({
        error:
    ...
    if (attemptId) {
      const existingAttempt = await prisma_1.default.quizAttempt.findFirst({
        where: {
          ...
          status: {
            in: [
              client_1.AttemptStatus.IN_PROGRESS,
              client_1.AttemptStatus.PAUSED,
            ],
          },
        },
      });
