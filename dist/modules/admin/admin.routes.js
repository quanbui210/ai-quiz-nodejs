...
router.put(
  ...
  admin_controller_1.changeUserSubscription,
);
router.post(
  "/users/:userId/make-admin",
  admin_middleware_1.requireSuperAdmin,
  admin_controller_1.makeAdmin,
);
router.delete(
  "/users/:userId/revoke-admin",
  admin_middleware_1.requireSuperAdmin,
  admin_controller_1.revokeAdmin,
);
router.get("/plans", admin_controller_1.listPlans);
router.post(
  "/plans",
  admin_middleware_1.requireSuperAdmin,
  admin_controller_1.createPlan,
);
router.put(
  "/plans/:planId",
  admin_middleware_1.requireSuperAdmin,
  admin_controller_1.updatePlan,
);
router.delete(
  "/plans/:planId",
  admin_middleware_1.requireSuperAdmin,
  admin_controller_1.deletePlan,
);
