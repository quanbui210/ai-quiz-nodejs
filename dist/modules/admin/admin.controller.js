...
exports.deletePlan =
  ...
  exports.revokeAdmin =
  exports.makeAdmin =
  exports.changeUserSubscription =
  exports.updateUserLimits =
  exports.getUser =
  exports.listUsers =
...
const getDashboard = async (req, res) => {
  try {
    ...
    const detailedSubscriptions =
      await prisma_1.default.userSubscription.findMany({
        where: {
          status: "ACTIVE",
        },
        include: {
...
const updateUserLimits = async (req, res) => {
  try {
    ...
    if (!subscription) {
      const { getOrCreateDefaultSubscription } = await Promise.resolve().then(
        () => __importStar(require("../../utils/subscription")),
      );
...
const changeUserSubscription = async (req, res) => {
  try {
    ...
    const { updateSubscriptionFromPlan } = await Promise.resolve().then(() =>
      __importStar(require("../../utils/subscription")),
    );
