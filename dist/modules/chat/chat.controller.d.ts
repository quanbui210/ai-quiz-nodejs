...
export declare const getAvailableModels: (req: AuthenticatedRequest, res: Response) => Promise<Response<any, Record<string, any>>>;
...
export declare const updateChatSessionModel: (req: AuthenticatedRequest, res: Response) => Promise<Response<any, Record<string, any>>>;
